<template>
  ...
  <p v-if="score" >=A...</p>
  <p v-else-if="score" >=B...</p>
  <p v-else-if="score" >=C...</p>
  <p v-else-if="score" >=D...</p>
  <p v-else>F...</p>
  ...
  <h4>submit 예제</h4>
  <form v-0n:submit.prevent="submitHander1">
    <table border="1">
      <tr>
        <td>아이디</td>
  ...
  <h4>form 예제</h4>
  <form v-0n:submit.prevent="submitHander2">
    <table border="1">
      <tr>
        <td>아이디</td>
